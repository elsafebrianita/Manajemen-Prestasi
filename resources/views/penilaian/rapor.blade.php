...
<head>
    ...
    <title>Rapor Hasil Belajar - SIMPRES</title>
    ...
    <div class="container">
        ...
        @if($penilaian && $penilaian->is_published)
            @php
                ...
                if (!function_exists('terbilangStudent')) {
                    function terbilangStudent($angka) {
                        $angka = abs((int)$angka);
                        ...
                        if ($angka < 12) {
                            ...
                            $terbilang = terbilangStudent($angka - 10) . " Belas";
                        } else if ($angka < 100) {
                            $terbilang = terbilangStudent(floor($angka / 10)) . " Puluh" . terbilangStudent($angka % 10);
                        }
                        ...
                        <div class="dashboard-card performance-card">
                            ...
                            <div class="kpi-score-wrapper">
                                <div class="kpi-score-circle">
                                    <span class="kpi-score-num">{{ number_format($penilaian->kpi_score, 1) }}</span>
                    ...
                    <div class="dashboard-main">
                        ...
                        <div class="dashboard-card summary-card">
                            <div>
                                ...
                                <p class="summary-spelled">{{ terbilangStudent($displayAverage) }} Poin</p>
                            </div>
                            ...
                            <div class="subjects-list">
                                ...
                                @empty
                                    <div style="text-align: center; padding: 30px; color: var(--text-muted);">
                                        ...
                                        Mata pelajaran kelas Anda belum disinkronisasikan. Hubungi Wali Kelas.
                                    </div>
                                @endforelse
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            @foreach($mapels as $index => $m)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($grade)
                                            {{ terbilangStudent($grade->nilai) }} | <strong>{{ $predikat }}</strong>
                                        @else
                                            -
                            ...
                            <tr style="background: #f8fafc;">
                                ...
                                <td class="font-bold" style="border: 2px solid #000;">
                                    {{ terbilangStudent($displayAverage) }} Poin
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="kpi-info-box">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>: {{ number_format($penilaian->kpi_score, 1) }} (Peringkat ke-{{ $penilaian->ranking ?? '-' }})</td>
                            </tr>
                            <tr>
        ...
        @else
            ...
            <div class="locked-container">
                ...
                <div class="locked-title">Rapor Belum Diterbitkan</div>
                <div class="locked-desc">
                    Wali Kelas Anda (<strong>{{ $siswa->walikelas->name ?? 'Wali Kelas' }}</strong>) belum melakukan finalisasi atau mempublikasikan rapor untuk semester ini. Nilai-nilai mata pelajaran Anda sedang berada dalam tahap draft penyelarasan.
                </div>
                <a href="/dashboard" class="btn-print" style="background: var(--secondary); text-decoration: none;">
                    <i class="fas fa-arrow-left"></i> Kembali ke Dashboard
                </a>
            </div>
        @endif
