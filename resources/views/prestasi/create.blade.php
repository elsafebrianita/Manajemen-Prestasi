...
<head>
    ...
    <title>Pendataan Prestasi - SMK N 1 TALAMAU</title>
...
<body>
    <div class="container">
        <div class="header-section">
            <span class="label-top">Formulir Akademik</span>
            <h1>PENDATAAN PRESTASI BARU</h1>
            <span class="school-name">SMK N 1 TALAMAU</span>
        </div>

        <div class="card">
            <h2><i class="fas fa-edit"></i> Input Capaian Prestasi Siswa</h2>
            ...
            <form action="/prestasi/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        @else
                            <input type="text" name="siswa_name" list="students" placeholder="Ketik nama atau NIS siswa..." required style="padding-left: 45px;">
                            <datalist id="students">
                                @foreach($siswa as $s)
                ...
                <div class="grid-2">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select id="kategori_utama" required onchange="updateSubKategori()">
                                ...
                                @foreach($kategori_utama as $utama)
                                    <option value="{{ $utama->id }}">{{ $utama->nama_kategori }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select name="kategori_id" id="kategori_sub" required disabled>
                                <option value="" disabled selected>Pilih Bidang Dulu...</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="nama_prestasi" placeholder="Misal: Lomba LKS Teknik Komputer" required>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select name="juara" id="juara_select" required>
                                <option value="" disabled selected>Pilih Peringkat/Juara...</option>
                ...
                <div class="grid-2">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="date" name="tanggal_capaian" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="lokasi" placeholder="Misal: Padang, Aula Dinas Pendidikan" required>
                        </div>
                    </div>
                </div>

                <div class="form-group">
                    <label>Unggah Sertifikat / Bukti (PDF Saja)</label>
                    <div class="input-wrapper">
            ...
            <a href="/prestasi/riwayat" class="btn-back">← Kembali ke Riwayat Prestasi</a>
        </div>
    </div>
    <script>
        ...
        function updateSubKategori() {
            ...
            // Reset options
            subSelect.innerHTML = '<option value="" disabled selected>Pilih Bidang...</option>';
            ...
            if (utamaId) {
                ...
                if (selectedUtama && selectedUtama.children && selectedUtama.children.length > 0) {
                    ...
                    subSelect.innerHTML = '<option value="" disabled selected>Tidak ada bidang tersedia</option>';
                ...
                subSelect.innerHTML = '<option value="" disabled selected>Pilih Kategori Dulu...</option>';
                subSelect.disabled = true;
            }
        }
    </script>
